...
const UTILITY_COPY = {
  ...
  "/cart": ["سبد خرید نمایشی — SOLE", "سبد خرید محلی نمونه SOLE؛ سفارش، ارسال و پرداخت واقعی متصل نیستند."],
  "/checkout": ["Checkout نمایشی — SOLE", "مرور رابط Checkout نمونه SOLE بدون ثبت سفارش، ارسال یا پرداخت واقعی."],
  "/wishlist": ["علاقه‌مندی‌ها — SOLE", "فهرست علاقه‌مندی‌های محلی نسخه نمایشی SOLE در همین مرورگر."],
  "/account": ["حساب نمایشی — SOLE", "داشبورد محلی نمونه SOLE برای رابط پروفایل، آدرس و سفارش بدون Backend واقعی."],
} as const;
