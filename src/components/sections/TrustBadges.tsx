...
const items = [
  {
    ...
    description:
      "سایزهای هر مدل از Dataset فعلی نمایش داده می‌شوند و انتخاب نهایی هنوز نمایشی است.",
  },
  {
    icon: Database,
      ...
      <div className="page-container-wide">
        <div className="mb-8 max-w-3xl">
          ...
          <p className="mt-3 font-fa leading-7 text-muted-foreground">
            به‌جای اعتمادسازی با وعده‌های تأییدنشده، محدودیت‌ها و امکانات واقعی Frontend شفاف نمایش
            داده می‌شوند.
          </p>
        </div>
